...
watch:
  cargo watch -x 'run -- --collector.default --collector.exporter --collector.tls --collector.query_response_time --collector.audit --collector.statements --collector.schema --collector.replication --collector.locks --collector.metadata --collector.userstat -v'
